  ...
  return (
    <div className="min-h-screen bg-[#667470] text-[#32373c]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Faturas a Emitir */}
        <Link href="/admin/faturas-clientes">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-center gap-4 hover:border-[#667470]/30 active:scale-[0.98] transition-all cursor-pointer">
            ...
            <div className="flex-1">
              <p className="font-bold text-[#32373c]">Faturas a Emitir</p>
              <p className="text-sm text-gray-400">Serviços finalizados · aguardam fatura ao cliente</p>
            </div>
            {finalisedCount > 0 && (
              <span className="text-xs bg-blue-500 text-white font-bold px-2.5 py-1 rounded-full flex-shrink-0">
                {finalisedCount}
              </span>
            )}
