        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="px-4 py-3 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="tel:+351912345678" className="text-sm font-medium text-[#6B8878] underline underline-offset-2">
                +351 912 345 678
              </a>
            </div>
            <div>
            ...
            {[
              ...
              <li key={tx.supplier} className="bg-white rounded-xl border border-gray-100 shadow-sm p-3 space-y-1">
                ...
                {tx.status === "Pending Receipt" && (
                  <button className="mt-1 text-xs text-[#6B8878] font-semibold hover:underline">
                    + Adicionar Recibo
                  </button>
                )}
              </li>
