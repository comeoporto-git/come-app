                    ...
                    <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                      ...
                      {tx.comprovantivoUrl && (
                        <a
                          ...
                          className="flex items-center gap-1 text-xs text-emerald-700 bg-emerald-50 border border-emerald-200 px-1.5 py-0.5 rounded-full font-medium hover:bg-emerald-100 transition-colors"
                        >
                          📄 <span>{tx.paidByName || displayName}{tx.transferDate ? ` · ${tx.transferDate}` : ""}</span>
                        </a>
                      )}
                    </div>
                  </div>
