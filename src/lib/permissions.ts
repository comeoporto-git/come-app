...
export type Role = "Admin" | "Guide" | "Super Guide" | "Accountant" | "Chef";

export const ALL_ROLES: Role[] = ["Admin", "Guide", "Super Guide", "Accountant", "Chef"];
...
export const FEATURES: Feature[] = [
  {
    ...
    path: "/guide",
    defaultRoles: ["Admin", "Guide", "Super Guide", "Chef"],
  },
  {
    key: "invoices",
